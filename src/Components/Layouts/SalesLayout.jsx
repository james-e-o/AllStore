...
const SalesLayout = () => {
  return (
    <div className="p-1 w-full h-full">
        ...
        <header className=" h-[14%] mb-3 rounded bg-slate-100 flex items-center">
        ...
        <main className="rounded p-2 bg-slate-100 h-[75%] mb-3">
          <Outlet/>
        </main>
        <div className="rounded  px-2 bg-slate-100 h-11"></div>
    </div>
  )
}
